...
class ParseArgsTests(unittest.TestCase):
    ...
    def test_accepts_error_retry_seconds(self) -> None:
        args = parse_args(["--error-retry-seconds", "45"])
        self.assertEqual(args.error_retry_seconds, 45)

    def test_default_error_retry_seconds(self) -> None:
        args = parse_args([])
        self.assertEqual(args.error_retry_seconds, buildbot.DEFAULT_ERROR_RETRY_SECONDS)
...
class RunLoopTests(unittest.TestCase):
    def test_interval_job_runtime_error_retries_soon(self) -> None:
        ...
        t0 = dt.datetime(2026, 7, 31, 13, 0, 0).timestamp()
